...
interface LoginFormProps {
    ...
    /** Mensagem vinda de um retorno de login com Google que deu errado. */
    avisoExterno?: string;
}

export default function LoginForm({ googleEnabled, avisoExterno }: LoginFormProps) {
