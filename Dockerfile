...
CMD ["sh", "-c", "node scripts/utils/add_transaction_kind_column.js && node scripts/utils/make_phone_nullable.js && node scripts/utils/add_invite_token_columns.js && npm start"]
